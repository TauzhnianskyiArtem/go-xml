[![GoDoc](https://godoc.org/github.com/TauzhnianskyiArtem/go-xml?status.svg)](https://godoc.org/github.com/TauzhnianskyiArtem/go-xml) [![Build Status](https://travis-ci.org/droyo/go-xml.svg?branch=master)](https://travis-ci.org/droyo/go-xml)
...
```
go get github.com/TauzhnianskyiArtem/go-xml/...
```
